    ...
    <div className="container mx-auto px-4 py-12">
      ...
      >
        <div className="md:w-1/2">
          ...
          >
            Hi, I&apos;m <span className="text-blue-600">Mesbah Tanvir</span>
          </motion.h1>
          ...
          >
            ...
            <Link 
              href="/contact" 
              className="border border-gray-300 hover:border-blue-600 hover:text-blue-600 px-6 py-3 rounded-md transition-colors duration-300"
            >
              Contact Me
            </Link>
          </motion.div>
